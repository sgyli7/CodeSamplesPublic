...
package org.rivello.projects.puremvctemplate.controller
{
     ...
     *
	*/
    public class FillTextWithAPhraseCommand extends SimpleCommand
    {        
		//--------------------------------------
		//  Methods
		//--------------------------------------		
		...
		*/	
        ...
        {			
        	...
        	//ECHO
        	trace ("FillTextWithAPhraseCommand.execute()");
            
            //VARIABLES
			var mainUIMediator : MainUIMediator = facade.retrieveMediator ( MainUIMediator.NAME ) as MainUIMediator;
			var phrasesProxy : PhrasesProxy = facade.retrieveProxy ( PhrasesProxy.NAME ) as PhrasesProxy;

			//PROPERTIES
			
			//METHODS
            mainUIMediator.setMessageText(phrasesProxy.message);
