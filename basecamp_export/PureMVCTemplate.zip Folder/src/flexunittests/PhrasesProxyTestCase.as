	...
	*/
	...
	{		
		...
		*/
  		...
  		{
   			assertEquals ( "", 	_phrasesProxy.buttonLabel,	"Click Me to See Message Above!");
   			assertEquals ( "", 	_phrasesProxy.message,		"<BR><P ALIGN='CENTER'>Hello World</P>");
   		}
		...
		*/
  		public function testGettersSetters () : void 
  		{
  			...
  			_phrasesProxy.message 		= "test2";
   			assertEquals ( "", 	_phrasesProxy.buttonLabel,	"test1");
   			assertEquals ( "", 	_phrasesProxy.message,		"test2");
   		}
